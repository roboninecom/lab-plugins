...
export const manifest: PluginManifest = {
  ...
  description: {
    en: 'Exposes robot and workspace data to AI assistants via the WebMCP API.',
    ru: 'Предоставляет данные о роботе и рабочем пространстве AI-ассистентам через WebMCP API.',
  },
  ...
  scopes: ['install', 'robot.read', 'user.auth', 'user.read'],
  provides: 'webmcp',
}
